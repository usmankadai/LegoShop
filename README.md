...
Due to the lack of time some features i desired to achieve were not implemented. If there was time i would have implemented make the search for inventories possible using array.filter
